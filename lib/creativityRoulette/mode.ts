...
export const modeProfiles: Record<CreativityMode, ModeProfile> = {
  useful: {
    ...
    exerciseLead: "Useful pass: do this in the smallest practical form first.",
    exerciseClose:
  ...
  weird: {
    ...
    exerciseLead:
      "Weird pass: keep the core intention, then add one odd constraint, analogy, or wrong-but-interesting twist.",
    exerciseClose:
  ...
  wild: {
    ...
    exerciseLead:
      "Wild pass: do not only vary the idea. Change one rule, role, medium, system, or frame that defines the creative space.",
    exerciseClose:
